"""
Django settings for testapp_38485 project.
...
ROOT_URLCONF = 'testapp_38485.urls'
...
WSGI_APPLICATION = 'testapp_38485.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_38485 API",
    "DESCRIPTION": "API documentation for testapp_38485 App",
    "VERSION": "v1",
}
